...
def read_video_with_decord(video_path: str, change_fps=True):
    if change_fps:
        temp_dir = "temp"
    ...
    return VideoReader(target_video_path)
...
def write_video_stream(video_output_path: str, fps: int):
    """Create a video writer that supports streaming writing"""
